            ...
            <section className="border-b border-border p-5 sm:p-6 md:border-b-0 md:border-r">
              ...
              <div className="flex flex-wrap gap-2">
                {props.benefits.map((benefit, index) => (
                  <span
                    key={index}
                    className="inline-flex items-center gap-1.5 bg-category-indigo-subtle px-2.5 py-1.5 text-xs font-medium text-category-indigo-accent"
                  >
            ...
            <section className="p-5 sm:p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {props.values.map((value, index) => (
                  <span
                    key={index}
                    className="inline-flex items-center gap-1.5 bg-category-teal-subtle px-2.5 py-1.5 text-xs font-medium text-category-teal-accent"
                  >
                    <LucideCircleCheck className="h-3.5 w-3.5 shrink-0" />
                    {value.label}
                  </span>
