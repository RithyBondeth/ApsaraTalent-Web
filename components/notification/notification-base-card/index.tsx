...
export default function NotificationBaseCard(
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "group/card relative flex w-full items-start gap-3 overflow-hidden rounded-none border border-border bg-card p-4 shadow-hard transition-all duration-300 sm:gap-5 sm:p-5",
        onClick &&
