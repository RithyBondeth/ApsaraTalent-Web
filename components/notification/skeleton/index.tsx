...
export function NotificationCardSkeleton() {
  return (
    <div className="relative flex w-full items-start gap-3 overflow-hidden rounded-none border border-l-[5px] border-border border-l-foreground bg-card p-4 sm:gap-5 sm:p-5">
