  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "flex-1 text-center text-[0.7rem] font-medium uppercase tracking-[0.08em] text-muted-foreground",
        tbody: "block pt-2",
        ...
        day_today:
          "border border-foreground/45 bg-transparent font-medium text-foreground",
        day_outside:
