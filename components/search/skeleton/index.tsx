...
function SearchFilterSidebarSkeleton({ filterCount }: { filterCount: number }) {
  return (
    <div className="search-filter-panel flex w-72 shrink-0 flex-col border border-border bg-card tablet-xl:hidden xl:w-80">
...
function SearchPageLoadingSkeleton({
  ...
  return (
    <div className="search-editorial w-full" aria-busy="true">
      {/* Hero Section */}
      <PageBannerSkeleton statCount={1} controls={<SearchBarSkeleton />} />
