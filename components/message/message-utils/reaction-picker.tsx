    ...
    <Popover>
      ...
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 bg-background/50 opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100"
        >
      ...
      <PopoverContent
        side="top"
        align="center"
        className="w-fit border-muted bg-background/95 p-1 shadow-lg backdrop-blur-md"
      >
        {/* Emoji List Section */}
        <div className="flex gap-1">
          {CHAT_REACTION_EMOJIS.map((emoji) => (
            <button
              ...
              had. */
              className={`p-2 transition-[transform,background-color] duration-150 hover:scale-110 hover:bg-muted ${
