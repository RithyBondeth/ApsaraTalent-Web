      ...
      <DialogContent className="max-w-sm rounded-2xl">
        ...
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            {isEnableFlow ? (
              <LucideShieldCheck className="size-5 text-brand" />
            ) : (
              ...
              <>
                ...
                {secret && (
                  <div className="w-full flex flex-col gap-1">
                    ...
                    <code className="block select-all break-all rounded-xl border border-border/60 bg-muted/60 px-3 py-2 text-center font-mono text-xs">
                      {secret}
                    </code>
                  </div>
                )}
