 ...
 * actually drawing the glyphs. With Ubuntu first, Khmer fell through to the Khmer
 * face for glyphs but kept Ubuntu's ascent and descent — no room for the marks
 * Khmer stacks above and below, which is why headings read as having no leading.
 * See the Khmer block in globals.css.
 */
export const FONT_STACK = {
  en: "var(--font-ubuntu), var(--font-khmer), sans-serif",
  km: "var(--font-khmer), var(--font-ubuntu), sans-serif",
} as const;
