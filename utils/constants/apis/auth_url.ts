...
export const API_AUTH_SOCIAL_LINKEDIN_URL = API_BASE_URL + "/social/linkedin/login";
export const API_AUTH_SOCIAL_GITHUB_URL = API_BASE_URL + "/social/github/login";
export const API_AUTH_SOCIAL_FACEBOOK_URL = API_BASE_URL + "/social/facebook/login";