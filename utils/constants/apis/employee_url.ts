...
export const API_UPLOAD_EMP_AVATAR_URL = (employeeID: string) =>
  `${API_EMP_BASE_URL}/upload-avatar/${employeeID}`;
export const API_UPLOAD_EMP_RESUME_URL = (employeeID: string) =>
  `${API_EMP_BASE_URL}/upload-resume/${employeeID}`;
export const API_UPLOAD_EMP_COVER_LETTER_URL = (employeeID: string) =>
  `${API_EMP_BASE_URL}/upload-cover-letter/${employeeID}`;

export const API_REMOVE_EMP_AVATAR_URL = (employeeID: string) =>
  `${API_EMP_BASE_URL}/remove-avatar/${employeeID}`;
export const API_REMOVE_EMP_RESUME_URL = (employeeID: string) =>
