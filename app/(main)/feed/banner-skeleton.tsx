  ...
  return (
    <div className="w-full flex items-center justify-between gap-5 tablet-xl:flex-col tablet-xl:items-center">
      <div className="flex flex-col items-start gap-3 tablet-xl:w-full tablet-xl:items-center">
        <Skeleton className="h-8 w-[300px] tablet-xl:w-full tablet-xl:h-10" />
        <Skeleton className="h-6 w-[250px] tablet-xl:w-3/4" />
        <Skeleton className="h-5 w-[200px] tablet-xl:w-2/3" />
        <Skeleton className="h-4 w-[150px] tablet-xl:w-1/3" />
      </div>
