...
//         <div className="px-20 tablet-xl:px-10 flex justify-center items-center tablet-md:w-full tablet-md:h-full tablet-md:px-6 tablet-md:flex tablet-md:flex-col tablet-md:justify-center">
...
//             <TypographyH1 className="!leading-snug tablet-sm:text-2xl tablet-md:!leading-tight">
...
//         <div className="w-[80%] h-full relative tablet-md:!min-w-full tablet-md:h-full tablet-md:max-h-full">
//           <Image
//             src={landingSvg}
//             alt="landing"
//             fill
      ...
      <div className="w-1/2 z-10 h-fit flex justify-center items-center tablet-md:w-full tablet-md:mt-14 phone-xl:!mt-20">
        <div className="px-10 tablet-md:mt-10 tablet-md:mx-10 tablet-md:w-full tablet-md:h-fit phone-xl:!px-0">
          <div className="flex flex-col items-start gap-5 mb-10 tablet-md:gap-3">
            <TypographyH1 className="!leading-normal tablet-sm:text-3xl phone-xl:!text-2xl">
              Empowering Connections Between Talent and Opportunity
            </TypographyH1>
