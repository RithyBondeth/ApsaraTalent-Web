      ...
      <div className="w-1/2 flex justify-center items-center z-10">
        <div className="size-[70%] flex flex-col items-stretch justify-start">
            <div className="flex flex-col items-start gap-5 mb-10">
              <TypographyH1 className="!leading-normal">Empowering Connections Between Talent and Opportunity</TypographyH1>
            ...
            <Link href="/signup">
              <Button prefixIcon={<LucideBriefcaseBusiness/>}>Explore Now</Button>
            </Link>
        </div>
      </div>
